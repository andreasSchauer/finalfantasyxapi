...
func (cfg *apiConfig) newNamedAPIResourceFromType(endpoint, key string, lookup map[string]TypedAPIResource) (NamedAPIResource, error) {
...
func (cfg *apiConfig) newTypedAPIResourceList(r *http.Request, endpoint string, lookup map[string]TypedAPIResource) (TypedApiResourceList, error) {
...
func (cfg *apiConfig) createTypeResourceSlice(endpoint string, lookup map[string]TypedAPIResource) []TypedAPIResource {
