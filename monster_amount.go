...
func createMonsterAmounts(cfg *Config, items []seeding.MonsterAmount) []MonsterAmount {
	monsters := []MonsterAmount{}

	for _, item := range items {
		monster := createMonsterAmount(cfg, item)
...
func createMonsterAmount(cfg *Config, input seeding.MonsterAmount) MonsterAmount {
