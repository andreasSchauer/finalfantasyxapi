	...
	tests := []expCharacterClass{
		...
		},
		{
			...
			defaultAbilities: []string{
				"/player-abilities/45",
				"/player-abilities/53",
				"/generic-abilities/10",
				"/generic-abilities/18",
				"/generic-abilities/20",
				"/generic-abilities/21",
				"/generic-abilities/22",
				"/generic-abilities/23",
				"/generic-abilities/24",
			},
			learnableAbilities: []string{
				"/generic-abilities/11",
				"/generic-abilities/12",
				"/generic-abilities/13",
				"/generic-abilities/14",
				"/generic-abilities/15",
				"/generic-abilities/16",
				"/generic-abilities/17",
			},
