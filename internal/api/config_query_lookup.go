...
func (cfg *Config) initShopsParams() {
	params := []QueryParam{
		...
		{
			Name:        "auto_ability",
			Description: "Searches for shops that offer equipment with the specified auto-ability. Can be combined with 'empty_slots', 'character', and 'availability' for more specific searches.",
			Type:        "id",
			ForList:     true,
			ForSingle:   false,
			ReplacedBy:  []string{"availability"},
		...
		{
			Name:            "empty_slots",
			Description:     "Searches for shops that offer equipment with the specified amounts of empty slots. Can be combined with 'auto_ability', 'character', and 'availability' for more specific searches.",
			Type:            "int-list",
			ForList:         true,
			ForSingle:       false,
			ReplacedBy:  	 []string{"availability"},
		...
		{
			Name:        "character",
			Description: "Searches for shops that offer equipment for the specified character. Can be combined with 'auto_ability', 'empty_slots', and 'availability' for more specific searches.",
			Type:        "name/id",
...
func (cfg *Config) initAutoAbilitiesParams() {
	params := []QueryParam{
		...
		{
			Name:        "availability",
			Description: "Searches for auto-abilities with the given availabilities.",
			Type:        "enum-list",
			ForList:     true,
			ForSingle:   false,
			TypeLookup:  cfg.t.AvailabilityType.lookup,
		...
		{
			Name:        "character",
			Description: "Restricts the search for 'availability', 'monster' and 'shop' to only include auto-abilities that can be obtained by the specified character.",
			Type:        "name/id",
		...
		{
			Name:          "location",
			Description:   "Searches for auto-abilities that can be obtained at the specified location.",
			Type:          "id",
			ForList:       true,
			ForSingle:     false,
			ReplacedBy:    []string{"sublocation", "area", "availability", "repeatable"},
		...
		{
			Name:          "sublocation",
			Description:   "Searches for auto-abilities that can be obtained at the specified sublocation.",
			Type:          "id",
			ForList:       true,
			ForSingle:     false,
			ReplacedBy:    []string{"area", "availability", "repeatable"},
		...
		{
			Name:          "area",
			Description:   "Searches for auto-abilities that can be obtained in the specified area.",
			Type:          "id",
			ForList:       true,
			ForSingle:     false,
			ReplacedBy:    []string{"availability", "repeatable"},
