...
func parseEnumQuery[E, N any](r *http.Request, endpoint EndpointName, queryParam QueryParam, et EnumType[E, N]) (EnumAPIResource, error) {
...
func checkQueryEnum[E, N any](val string, endpoint EndpointName, queryParam QueryParam, et EnumType[E, N]) (EnumAPIResource, error) {
