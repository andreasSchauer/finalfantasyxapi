...
func TestGetPlayerAbility(t *testing.T) {
	tests := []expPlayerAbility{
		...
		{
			testGeneral: testGeneral{
				requestURL:     "/api/player-abilities/10?user=aeon:shiva",
...
func TestRetrievePlayerAbilities(t *testing.T) {
	tests := []expListIDs{
		...
		{
			testGeneral: testGeneral{
				requestURL:     "/api/player-abilities?copycat=true&std_sg=3&phys_atk=false",
				expectedStatus: http.StatusOK,
			},
			count:    3,
			previous: nil,
		...
		{
			testGeneral: testGeneral{
				requestURL:     "/api/player-abilities?silenceable=true&reflectable=false&char_class=3",
				expectedStatus: http.StatusOK,
			},
			count:    2,
			previous: nil,
