...
func (cfg *Config) retrievePlayerAbilities(r *http.Request, i handlerInput[seeding.PlayerAbility, PlayerAbility, NamedAPIResource, NamedApiResourceList]) ([]int32, error) {
	...
	return filterIDs(cfg, r, i, ids, []IdFilter{
		...
		nameIdQuery(r, i, ids, qpnUser, cfg.e.characterClasses.resTypeSing, cfg.l.CharClasses, cfg.db.GetPlayerAbilityIDsByCharClass),
		idQuery(r, i, ids, qpnLearnItem, cfg.l.Items, cfg.db.GetPlayerAbilityIDsByLearnItem),
		nameIdQuery(r, i, ids, qpnRelatedStat, cfg.e.stats.resTypeSing, cfg.l.Stats, cfg.db.GetPlayerAbilityIDsByRelatedStat),
		...
		nameIdQuery(r, i, ids, qpnStdSg, cfg.e.characters.resTypeSing, cfg.l.Characters, ToIntManyNull(cfg.db.GetPlayerAbilityIDsStdSgChar)),
		nameIdQuery(r, i, ids, qpnExpSg, cfg.e.characters.resTypeSing, cfg.l.Characters, ToIntManyNull(cfg.db.GetPlayerAbilityIDsExpSgChar)),
