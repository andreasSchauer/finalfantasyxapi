...
func (cfg *Config) retrievePlayerAbilities(r *http.Request, i handlerInput[seeding.PlayerAbility, PlayerAbility, NamedAPIResource, NamedApiResourceList]) (NamedApiResourceList, error) {
	...
	return filterAPIResources(cfg, r, i, resources, []filteredResList[NamedAPIResource]{
		frl(enumQuery(cfg, r, i, cfg.t.PlayerAbilityCategory, resources, "category", cfg.db.GetPlayerAbilityIDsByCategory)),
		frl(enumQuery(cfg, r, i, cfg.t.DamageType, resources, "damage_type", cfg.db.GetPlayerAbilityIDsByDamageType)),
		frl(enumQuery(cfg, r, i, cfg.t.AttackType, resources, "attack_type", cfg.db.GetPlayerAbilityIDsByAttackType)),
		frl(enumQuery(cfg, r, i, cfg.t.TargetType, resources, "target_type", cfg.db.GetPlayerAbilityIDsByTargetType)),
		...
		frl(intQuery(cfg, r, i, resources, "rank", NullToIntMany(cfg.db.GetPlayerAbilityIDsByRank))),
		...
		frl(nameOrIdQuery(cfg, r, i, resources, "std_sg", cfg.e.characters.resourceType, cfg.l.Characters, NullToIntMany(cfg.db.GetPlayerAbilityIDsStdSgChar))),
		frl(nameOrIdQuery(cfg, r, i, resources, "exp_sg", cfg.e.characters.resourceType, cfg.l.Characters, NullToIntMany(cfg.db.GetPlayerAbilityIDsExpSgChar))),
