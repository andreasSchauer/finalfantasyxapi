...
type Lookup struct {
	...
	MiscAbilities        map[string]MiscAbility
	MiscAbilitiesID      map[int32]MiscAbility
...
func lookupInit() (*Lookup, error) {
	defer h.MeasureTime("creating lookups")()

	l := Lookup{
		Hashes:               make(map[string]int32),
		Abilities:            make(map[string]Ability),
		AbilitiesID:          make(map[int32]Ability),
		MiscAbilities:        make(map[string]MiscAbility),
		MiscAbilitiesID:      make(map[int32]MiscAbility),
