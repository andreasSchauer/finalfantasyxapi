...
func convertBackgroundMusic(cfg *Config, bm seeding.BackgroundMusic) BackgroundMusic {
	return BackgroundMusic{
		...
		Areas: 					locAreasToLocationAPIResources(cfg, cfg.e.areas, bm.LocationAreas),
	}
}

type Cue struct {
	SceneDescription       	string         			`json:"scene_description"`
	TriggerArea    			*LocationAPIResource  	`json:"trigger_area"`
	IncludedAreas          	[]LocationAPIResource 	`json:"included_areas"`
	ReplacesEncounterMusic 	bool           			`json:"replaces_encounter_music"`
...
func convertCue(cfg *Config, cue seeding.Cue) Cue {
	var triggerAreaPtr *LocationAPIResource

	if cue.TriggerLocationArea != nil {
		triggerArea := locAreaToLocationAPIResource(cfg, cfg.e.areas, *cue.TriggerLocationArea)
	...
	return Cue{
		...
		IncludedAreas: 			locAreasToLocationAPIResources(cfg, cfg.e.areas, cue.IncludedAreas),
