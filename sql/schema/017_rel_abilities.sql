...
CREATE TABLE j_misc_abilities_learned_by (
    id INTEGER GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
    data_hash TEXT UNIQUE NOT NULL,
    misc_ability_id INTEGER NOT NULL REFERENCES misc_abilities(id),
...
DROP TABLE IF EXISTS j_misc_abilities_learned_by;
